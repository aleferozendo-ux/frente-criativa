...
const CONFIG = {
  ...
  // ---- PLANOS (edite os preços aqui) ----
  planos: [
    {
      nome: "Landing Page",
      preco: "R$ 497",
      destaque: false,
      descricao: "Página focada em apresentar uma oferta e transformar visitas em contatos.",
      itens: ["Página de alta conversão", "Adaptada para celular", "Botão de WhatsApp", "Formulário de contato", "SEO básico", "Até 2 ajustes"],
    },
    {
      nome: "Essencial",
      preco: "R$ 597",
      destaque: false,
      descricao: "Site profissional de uma página pra pequenos negócios.",
      itens: ["Página única completa", "Adaptado pro celular", "Botão de WhatsApp", "SEO básico", "Até 2 ajustes"],
    },
    {
      nome: "Profissional",
      preco: "R$ 797",
      destaque: true, // "Mais escolhido"
      descricao: "Site institucional de até 3 páginas com mais estrutura.",
      itens: ["Até 3 páginas", "Design personalizado", "Formulário + WhatsApp", "SEO básico", "Redes sociais", "Até 2 ajustes"],
    },
    {
      nome: "Completo",
      preco: "R$ 1.197",
      destaque: false,
      descricao: "Site institucional completo de até 5 páginas com portfólio.",
      itens: ["Até 5 páginas", "Design profissional", "Portfólio/projetos", "Formulário + WhatsApp", "SEO básico", "Publicação incluída"],
    },
  ],
